...
interface PinLocationIconProps {
    size?: number;
    color?: string;
}

export default function PinLocationIcon({ size = 20, color = '#004b2c' }: PinLocationIconProps) {
    return (
