...
export default function AmbulanceIcon({ size = 24, color = '#FF6B6B' }: AmbulanceIconProps) {
    return (
        <Svg width={size} height={size} viewBox="0 0 24 24">
            <G fill="none">
                <Path stroke={color} strokeLinecap="round" strokeWidth="1.5" d="M22 22H2" />
                <Path
                    stroke={color}
                    strokeWidth="1.5"
                ...
                />
                <Path stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M12 9V5m2 2h-4" />
                <Path
                    fill={color}
                ...
                />
                <Path stroke={color} strokeLinecap="round" strokeWidth="1.5" d="M10 15h.5m3.5 0h-1.5" />
            </G>
        </Svg>
    );
}
