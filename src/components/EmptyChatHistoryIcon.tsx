...
interface EmptyChatHistoryIconProps {
    size?: number;
    color?: string;
}

export default function EmptyChatHistoryIcon({ size = 40, color = '#CCC' }: EmptyChatHistoryIconProps) {
    return (
        <Svg width={size} height={size} viewBox="0 0 24 24">
            <Path
                fill={color}
                fillRule="evenodd"
                d="M11.25 2a.75.75 0 0 1 .75-.75c5.937 0 10.75 4.813 10.75 10.75S17.937 22.75 12 22.75S1.25 17.937 1.25 12a.75.75 0 0 1 1.5 0A9.25 9.25 0 1 0 12 2.75a.75.75 0 0 1-.75-.75"
                clipRule="evenodd"
            />
            <Path
                fill={color}
